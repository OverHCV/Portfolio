// [portfolio] La coordenada viene del quad a pantalla completa (vScreen, -1..1) en vez de
// gl_FragCoord / resolution: así no depende del tamaño del render target del postprocesado.
varying vec2 vScreen;
vec2 square_frame(vec2 screen_size){
  vec2 position = vScreen;
